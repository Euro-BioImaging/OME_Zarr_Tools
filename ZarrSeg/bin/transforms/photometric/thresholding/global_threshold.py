...
def isodata(img, bincount = 2000, return_thresholded = False):
...
def yen(img, bincount = 1024, return_thresholded = False):
    """ Applies the Yen thresholding algorithm based on 
        ...
        -----------
        img: array
            n-dimensional intensity array to be subjected to yen threshold calculation.
        bincount: int
            a scalar that specifies the count of bins used for the histogram calculation.
        return_thresholded: bool
            specifies if the threshold should be applied to the 'img' or directly returned.
...
def ridler(img, tol = 0.01, return_thresholded = False, random_start = False, verbous = False):
...
def ridler_wmean(img, bincount = 1024, tol = 0.01, return_thresholded = False, random_start = False, verbous = False):
    """ Applies a modification of the Ridler & Calvard's iterative thresholding algorithm. Instead of means,
        ...
        -----------
        img: array
            N-dimensional intensity array to be subjected to ridler_wmean threshold calculation.
        bincount: int
            A scalar that specifies the count of bins used for the histogram calculation.
        tol: float
...
def ridler_median(img, tol = 0.01, return_thresholded = False, random_start = False, verbous = False):
    """ Applies a modification of the Riddler's iterative thresholding algorithm. Instead of means,
        ...
        -----------
        img: array
            N-dimensional intensity array to be subjected to ridler_median threshold calculation.
        tol: float
            The tolerance threshold for the loss. If loss is below 'tol', the iterations are terminated.
        return_thresholded: bool
            Specifies if the threshold should be applied to the 'img' or directly returned.
...
def li(img, bincount = 1024, tol = 0.01, return_thresholded = False, random_start = False, verbous = False):
